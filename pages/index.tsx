...
const Home: NextPage = () => {
  const tableTitles: { title: string, date: string } = {
    title: "w-72 bg-bright-turquoise-500 text-blue-zodiac-500 text-sm uppercase border-r border-blue-zodiac-500",
  ...
  return (
    <div className="bg-blue-zodiac-600 min-h-screen grid place-items-center">
      <header className="absolute top-0 right-0 text-white">Hello world</header>
      <div className="container grid grid-cols-2 place-items-center grid-flow-col">
        ...
        <main className="bg-blue-zodiac-500 w-96 rounded p-3">
          <h1 className="text-bright-turquoise-500 text-xl text-center">Tasks</h1>
