...
export const TaskItems = ({ taskText, setEditting }: TaskText) => {
  ...
  return (
    <>
      <div className="dark:bg-bright-turquoise-500 bg-blue-zodiac-500 dark:text-blue-zodiac-500 text-bright-turquoise-500 text-sm flex items-center justify-between p-2 rounded transition-colors">
